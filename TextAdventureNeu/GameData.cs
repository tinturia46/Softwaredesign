...
namespace NewTextAdventure
{
    class GameData
    {
        ...
        {
            // Create Rooms
            Item key = new Item { itemName = "Key", itemDescription = "After beating the first monster, you got this Key!", strengthPoints = 0, defensePoints = 0, isEquipped = false };
            ...
            // Create Entities
            Entity monster1 = new Entity { entityName = "stinky monster", entitiyDescription="It's a stinky, green monster",health = 100, strength = 30, defence = 24, stillalive = true, speech1 = "*fart*.. ahahahaha" };
            Entity monster2 = new Entity { entityName = "filthy monster", entitiyDescription="It's a filthy, blue monster",health = 120, strength = 40, defence = 32, stillalive = true, speech1 = "*Skrreeeeeeeeech*" };
            Entity monster3 = new Entity { entityName = "Megamonster", entitiyDescription="It's a filthy, red monster",health = 150, strength = 50, defence = 48, stillalive = true, speech1 = "you. will.. NEVER. DEFEAT. MEE!" };
            Entity guard = new Entity { entityName = "guard",entitiyDescription="It's a Guard!", health = 375, strength = 100, defence = 120, stillalive = true, speech1 = "Welcome to your challenge Hero! bring me 3 Monster Skulls and I will let you out of here. You can have this Key for starters, but I suggest you to not pass the locked door until you haven't slain the first Monster!", speech2 = "Woah, You Did It! Congratlations! I'll bring you out of here!" };
            Entity old_man = new Entity { entityName = "old man",entitiyDescription="It's an old man...", health = 375, strength = 100, defence = 120, stillalive = true, speech1 = "Hello Youngster, Bring me my Amulet and i will reward You!", speech2 = "It is Dangerous to go alone, take this!" };
